...
from cosmos_predict2.pipelines.multiview import MultiviewVideo2WorldPipeline
from imaginaire.model import ImaginaireModel
from imaginaire.utils import log

class MultiviewPredict2Video2WorldModel(Predict2Video2WorldModel):
    def __init__(self, config: Predict2Video2WorldModelConfig):
        ...
        self.pipe = MultiviewVideo2WorldPipeline.from_config(
            config.pipe_config,
