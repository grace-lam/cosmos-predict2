...
from cosmos_predict2.configs.vid2vid.defaults.conditioner import (
    _SHARED_CONFIG,
    GeneralConditioner,
    ReMapkey,
    T2VCondition,
...
class MultiViewCondition(Vid2VidCondition):
...
MultiViewConditionerConfig: LazyDict = L(MultiViewConditioner)(
    **_SHARED_CONFIG,
    view_indices_B_T=L(ReMapkey)(
        ...
        # TODO: Rename output key to latent_view_indices_B_T
